...
const CreactContainer = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center flex-col">
      <div className="w-[90%] md:w-[75%] border border-gray-200 rounded-lg p-4 flex flex-col items-start justify-center gap-2">
        ...
        <div className="w-full">
          <select
            ...
            value={catagory}
            className="w-full outline-none border-none border-b-2 border-gray-600 py-2 bg-white text-gray-400"
          >
            <option className=" text-gray-500 p-2" value="order">
              Secelect Categoey
            </option>
            {category &&
              category.map((item) => {
                return (
                  <option
                    className=" text-gray-500 p2"
                    key={item.id}
                    value={item.urlPrameName}
                  >
                    {item.name}
                  </option>
                );
            ...
            <>
              {!imageAsset ? (
                ...
                <div className="h-full relative">
                  ...
                  />
                  <button
                    className="absolute bottom-3 right-3 cursor-pointer outline-none p-3 bg-red-400 rounded-md hover:shadow-sm duration-500 ease-in-out"
                    onClick={DelectImg}
                  >
                    Delect Image
                  </button>
        ...
        <div>
          <button
            ...
            className="py-2 px-10 text-gray rounded-xl my-2  bg-green-400 hover:bg-green-600 transition-all duration-300 ease-in-out "
          >
            Save
          </button>
        </div>
